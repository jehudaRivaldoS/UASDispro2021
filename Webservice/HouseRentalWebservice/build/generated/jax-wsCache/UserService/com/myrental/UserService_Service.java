 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://myrental.com/", wsdlLocation = "http://localhost:8080/HouseRentalWebservice/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://myrental.com/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/HouseRentalWebservice/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://myrental.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myrental.com/", "UserServicePort"), UserService.class, features);
    }
