...
//                                String img = request.getAttribute("blob").toString();
                        ...
                        <div class="col-md-4">
                            <div class="productbox">
                                <div class="fadeshop">
                                    ...
                                    <span><img src="assets/images/<%=nama%>1.jpeg" class="pic" name=<%=id%>></span>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="productbox">
                                <div class="fadeshop">
                                    ...
                                    <span><img src="assets/images/<%=nama%>1.jpeg" class="pic" name="<%=nama%>"></span>
                                </div>
                                <div class="product-details">
                                    <form method="POST" action="tampilanRumah.jsp" style="padding-bottom:0px;">
                                        <input type="hidden" name="id" value=<%=id%>>
