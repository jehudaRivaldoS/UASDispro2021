...
public class FormReservasi extends javax.swing.JFrame implements Runnable {
    ...
    public FormReservasi(Socket s, int no, String nama) {
        initComponents();
        try {
            this.client = s;
            user = nama;
    ...
    private void initComponents() {
        ...
        txtAreaPesan.setFont(new java.awt.Font("Fira Code Retina", 0, 12)); // NOI18N
        txtAreaPesan.setRows(5);
        scrllPanePesan.setViewportView(txtAreaPesan);

        lblJudul.setFont(new java.awt.Font("SF UI Text", 1, 24)); // NOI18N
        lblJudul.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblJudul.setText("SEWA PROPERTI");

        txtFieldPesan.setFont(new java.awt.Font("Fira Code Retina", 0, 12)); // NOI18N
    ...
    private void showChat() {
        try {
            ...
            if (diterima.contains("check-in") || diterima.contains("durasi sewa") || diterima.contains("jenis pembayaran")
                ...
                i = 1;
            } else if (diterima.contains("Finish")) {
                onWhile = false;
                this.dispose();
            } else if (diterima.contains("Tanggal telah terpakai! Silahkan masukkan tanggal masuk kembali (YYYY-MM-DD):")) {
                i--;
            }
    ...
    private void btnKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKirimActionPerformed
        try {
            ...
            if (msg.contains("sewa")) {
                ...
                msg = "sewa/" + str[1] + "/1";
            } else if ((!msg.contains("sewa")) && i > 1 && !msg.isEmpty()) {
